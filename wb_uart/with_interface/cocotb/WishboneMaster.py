...
class WishboneMaster:
    def __init__ (self, dut):
        ...
        self.wb_ack_i = dut.wb_ack
        self.wb_err_i = dut.wb_err
        self.wb_dat_i = dut.wb_rdt
        self.wb_rty_i = dut.wb_rty
        self.wb_dat_o = dut.wb_dat
        self.wb_cyc_o = dut.wb_cyc
        self.wb_stb_o = dut.wb_stb
        self.wb_sel_o = dut.wb_sel
        self.wb_we_o = dut.wb_we
        self.wb_cti_o = dut.wb_cti
        self.wb_bte_o = dut.wb_bte
        self.wb_adr_o = dut.wb_adr
