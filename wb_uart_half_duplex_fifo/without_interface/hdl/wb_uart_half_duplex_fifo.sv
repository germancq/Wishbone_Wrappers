/**
 * File              : uart_half_duplex_wb.sv
 * Author            : German C.Quiveu <germancq@dte.us.es>
 * Date              : 06.04.2025
 * Last Modified Date: 06.04.2025
 * Last Modified By  : German C.Quiveu <germancq@dte.us.es>
 */
module wb_uart_half_duplex_fifo #(
  ...
  uart_half_duplex_fifo #(
      ...
      .tx_active(tx_active),
      .read_byte(read_byte),
      .estado_tx(debug_estado_tx),
      .estado_rx(debug_estado_rx),
      .debug_pop_tx(debug_pop_tx),
      .debug_data_tx(debug_data_tx),
      .debug_start_tx(debug_start_tx),
